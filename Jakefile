...
app (projectName, function(task)
{
    ...
    task.setBuildIntermediatesPath(FILE.join("Build", "CappuccinoCookBook.build", configuration));
    task.setBuildPath(FILE.join("Build", configuration));

    task.setProductName("Cappuccino-CookBook");
    task.setIdentifier("com.yourcompany.CappuccinoCookBook");
    task.setVersion("1.0");
    task.setAuthor("Army of Me, Inc.");
    task.setEmail("feedback @nospam@ yourcompany.com");
    task.setSummary("Cappuccino-CookBook");
